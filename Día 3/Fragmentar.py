...
fragmento = texto[::-1] #al dejar los :: en blanco nos permite tomar todos, pero si agregamos un numero despues del ultimo : nos permite ir de 2 en 2 en este caso, negativos van de derecha a izquierda
print(fragmento)
